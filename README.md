[](https://s33.aconvert.com/convert/p3r68-cdx67/va2bp-xliyk.mp4
...
|   功能   |                             简介                             |
| :------: | :----------------------------------------------------------: |
| 订单管理 | 导入订单；**一键放箱**；快捷预录；**打印装箱单**；生成电子装箱单；船期查询；导出运单excel表格。 |
| 调度管理 | 支持多种业务模式派车；**对接上港EIR**一键派单；各种费用智能匹配；配合小程序实现提箱点和箱封号皮重信息**自动填写补全**。 |
...
- **一键预录**
<center class="half">
    <img src="https://container-system.oss-cn-shanghai.aliyuncs.com/container/doc/prerecord.jpg" width="300"/>
</center>

无需重复录入繁杂的数据，轻松一点就可以实现预录。同时，该系统有严谨的校验逻辑，极大地**提高了预录的成功率**，并及时获取预录结果。此外，还可以查看到该订单的开港日期、截港日期，合理安排运输环节。
...
司机录入支持**模糊匹配**，各种费用**智能匹配**，杂七杂八费用可随时添加，对接**上港EIR**，一次派车司机即可立即**自动接单**，无需再次派车，派车记录随时车看，订单情况可追踪。
